...
class Movies(Dataset):
    ...
    def __init__(self):
        ...
        self.tokenize = BertTokenizer().tokenizeText
    ...
    def __getitem__(self, idx):
        ...
        movie_text_tokens, movie_text_mask = self.tokenize(movie_descr, maxLength=config.padded_language_length_question)   #tokenization of the movie description

        return sample["userId"],sample["movieId"], image_tensor, movie_text_tokens, movie_text_mask
