...
class MM_RecSys(nn.Module):
    def __init__(self):
        ...
        self.feature_extractor = get_feature_extractor(
            config.feature_extractor, h_dim=config.h_dim
        )
    ...
    def forward(self, poster, description, description_mask):
        ...
        description_encoded = self.language_encoder(
            description, description_mask
        )  # [batch_size, config.question_length, 768 (bert)]
